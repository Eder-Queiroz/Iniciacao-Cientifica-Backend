/*
  ...
  - You are about to drop the `restricao` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "disciplina" DROP CONSTRAINT "disciplina_curso_id_fkey";

-- DropForeignKey
ALTER TABLE "disciplina" DROP CONSTRAINT "disciplina_professor_id_fkey";

-- DropForeignKey
ALTER TABLE "restricao" DROP CONSTRAINT "restricao_professor_id_fkey";

-- DropForeignKey
ALTER TABLE "turma" DROP CONSTRAINT "turma_curso_id_fkey";
